  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-md">
      ...
      <p className="text-gray-600">
        Desde aquí puedes gestionar todas las secciones del sistema: empleados,
        actividades, recomendaciones, reportes y más.
      </p>

      <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 bg-[#e6f4ea] border border-[#c3e6cb] rounded-lg shadow-sm">
          <h3 className="font-semibold text-green-800">Usuarios</h3>
          <p className="text-green-700">Administra los empleados registrados.</p>
        </div>
